...
//    Sum* MRFT_bias_roll = new Sum(std::plus<float>());
    ...
    X_Saturation->getPorts()[(int)Saturation::ports_id::OP_0_DATA]->connect(hold_ref_roll->getPorts()[(int)HoldVal::ports_id::IP_0_DATA]);
    hold_ref_roll->getPorts()[(int)HoldVal::ports_id::OP_0_DATA]->connect(sum_ref_roll->getPorts()[(int)Sum::ports_id::IP_0_DATA]);
    ...
    error_mux_roll->getPorts()[(int)Mux3D::ports_id::OP_0_DATA]->connect(MRFT_sw_roll->getPorts()[(int)Switch::ports_id::IP_0_DATA]);
    MRFT_sw_roll->getPorts()[(int)Switch::ports_id::OP_0_DATA_DEFAULT]->connect(PID_roll->getPorts()[(int)PIDController::ports_id::IP_0_DATA]);
...
//    Sum* MRFT_bias_pitch = new Sum(std::plus<float>());
    ...
    Y_Saturation->getPorts()[(int)Saturation::ports_id::OP_0_DATA]->connect(hold_ref_pitch->getPorts()[(int)HoldVal::ports_id::IP_0_DATA]);
    ...
    error_mux_pitch->getPorts()[(int)Mux3D::ports_id::OP_0_DATA]->connect(MRFT_sw_pitch->getPorts()[(int)Switch::ports_id::IP_0_DATA]);
    MRFT_sw_pitch->getPorts()[(int)Switch::ports_id::OP_0_DATA_DEFAULT]->connect(PID_pitch->getPorts()[(int)PIDController::ports_id::IP_0_DATA]);
...
//    MRFT_bias_pitch->getPorts()[(int)Sum::ports_id::OP_0_DATA]->connect(((Block*)myActuationSystem)->getPorts()[(int)HexaActuationSystem::ports_id::IP_1_DATA_PITCH]);
    ...
    Sum* MRFT_bias_z = new Sum(std::plus<float>());

    ros_mrft_trigger_z->getPorts()[(int)ROSUnit_SetFloatSrv::ports_id::OP_2]->connect(hold_ref_z->getPorts()[(int)HoldVal::ports_id::IP_1_TRIGGER]);
    ros_mrft_trigger_z->getPorts()[(int)ROSUnit_SetFloatSrv::ports_id::OP_2]->connect(MRFT_sw_z->getPorts()[(int)Switch::ports_id::IP_1_TRIGGER]);

    rosunit_waypoint_z->getPorts()[(int)ROSUnit_FloatSub::ports_id::OP_2]->connect(hold_ref_z->getPorts()[(int)HoldVal::ports_id::IP_0_DATA]);
    hold_ref_z->getPorts()[(int)HoldVal::ports_id::OP_0_DATA]->connect(sum_ref_z->getPorts()[(int)Sum::ports_id::IP_0_DATA]);
    ...
    error_mux_z->getPorts()[(int)Mux3D::ports_id::OP_0_DATA]->connect(MRFT_sw_z->getPorts()[(int)Switch::ports_id::IP_0_DATA]);
    ...
    PID_z->getPorts()[(int)PIDController::ports_id::OP_0_DATA]->connect(MRFT_bias_z->getPorts()[(int)Sum::ports_id::IP_1_DATA]);
    MRFT_z->getPorts()[(int)MRFTController::ports_id::OP_0_DATA]->connect(MRFT_bias_z->getPorts()[(int)Sum::ports_id::IP_0_DATA]);
    MRFT_bias_z->getPorts()[(int)Sum::ports_id::OP_0_DATA]->connect(((Block*)myActuationSystem)->getPorts()[(int)HexaActuationSystem::ports_id::IP_3_DATA_Z]);
    ...
    MRFT_roll->getPorts()[(int)MRFTController::ports_id::OP_0_DATA]->connect(((Block*)myROSBroadcastData)->getPorts()[(int)ROSUnit_BroadcastData::ports_id::IP_3_ROLL_OUTPUT]);
    ...
    MRFT_pitch->getPorts()[(int)MRFTController::ports_id::OP_0_DATA]->connect(((Block*)myROSBroadcastData)->getPorts()[(int)ROSUnit_BroadcastData::ports_id::IP_4_PITCH_OUTPUT]);
